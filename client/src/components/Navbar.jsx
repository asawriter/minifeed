    ...
    <div className="navbar">
      <div className="left">
        ...
        <ul>
          ...
          <Link to="/saved/feeds" className="link">
            <li>
              <AiOutlinePlus />
              Create Post
            </li>
        ...
        {currentUser ? (
          <>
            <Link to={`/saved/feeds/${currentUser.userId}`} className="link">
              <div className="savedFeed">Saved Feed</div>
            </Link>
            <div className="account">
              ...
              {openOptions && (
                <ul onClick={() => setOpenOptions(!openOptions)}>
                  <Link to={`/profile/${currentUser.userId}`} className="link">
                    <li>
          ...
          <>
            ...
            <Link to="/register" className="link">
              <button style={{ color: "blueviolet", backgroundColor: "#fff" }}>
                Register
              </button>
            </Link>
          </>
